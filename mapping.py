...
PEFT_TYPE_TO_PREFIX_MAPPING[PeftType.LAVA] = "adapter_model"

# 2. Config 및 Tuner 클래스 연결
try:
    from .tuners.lava import LavaConfig, LavaModel
    PEFT_TYPE_TO_CONFIG_MAPPING[PeftType.LAVA] = LavaConfig
    PEFT_TYPE_TO_TUNER_MAPPING[PeftType.LAVA] = LavaModel
except ImportError:
    # 만약 소스 코드 경로가 peft/tuners/lava 가 아닐 경우 에러 방지
    pass